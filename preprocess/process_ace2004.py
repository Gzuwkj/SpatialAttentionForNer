...
def read_sgm_file(path: str, entities,
    ...
    if 'NYT20001218.2144.0401.sgm' in path:  # this sentence need special preprocess
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', default='data/ace_2004/data', help='Path to the input folder')
