...
def read_sgm_file(path: str, entities,
    ...
    if 'rec.sport.disc_20050209.2202.sgm' in path:  # this sentence need special preprocess
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', default='data/ace_2005/data', help='Path to the input folder')
    parser.add_argument('-o', '--output', default='outputs/ace_2005/', help='Path to the output folder')
